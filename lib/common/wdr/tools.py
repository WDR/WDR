...
_defaultExportConfig = {
    ...
    'Cell': {
        ...
        'children': [
            'Node', 'ServerCluster', 'JDBCProvider'
        ]
    },
    'ServerCluster': {
        'keys': ['name'],
        'attributes': [
            'description', 'preferLocal', 'nodeGroupName', 'enableHA',
            'serverType', 'jsfProvider', 'clusterAddress', 'prefetchDWLMTable',
            'members'
        ],
    ...
    'JDBCProvider': {
        'keys': ['name'],
        'attributes': [
            'description', 'classpath', 'nativepath', 'providerType',
            'propertySet', 'implementationClassName', 'xa'
        ],
        'children': ['DataSource']
    },
    ...
    'DataSource': {
        'keys': ['name'],
        'attributes': [
            'jndiName', 'statementCacheSize', 'logMissingTransactionContext',
            'properties', 'propertySet', 'datasourceHelperClassname',
            'authDataAlias', 'xaRecoveryAuthAlias', 'connectionPool'
        ],
        'children': []
    },
    'ConnectionPool': {
        'keys': [],
        'attributes': [
            'connectionTimeout', 'maxConnections', 'minConnections', 'reapTime',
            'unusedTimeout', 'agedTimeout', 'purgePolicy',
            'numberOfSharedPoolPartitions', 'numberOfUnsharedPoolPartitions',
            'numberOfFreePoolPartitions', 'freePoolDistributionTableSize',
            'surgeThreshold', 'surgeCreationInterval', 'testConnection',
            'testConnectionInterval', 'stuckTimerTime', 'stuckTime',
    ...
    'JavaVirtualMachine': {
        'keys': [],
        'attributes': [
            'initialHeapSize', 'maximumHeapSize', 'genericJvmArguments',
            'bootClasspath', 'classpath', 'systemProperties',
            'verboseModeClass', 'verboseModeGarbageCollection',
            'verboseModeJNI', 'runHProf', 'hprofArguments', 'debugMode',
            'debugArgs', 'disableJIT', 'internalClassAccessMode'
        ]
    },
    'Property': {
        'keys': ['name'],
